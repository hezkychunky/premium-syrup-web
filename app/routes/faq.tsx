...
export default function Faq() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="flex-grow flex flex-col gap-8 items-center pt-36 pb-10 bg-[theme(--color-secondary)] font-light">
          ...
          <section>
            ...
            {openDrawer.includes("shipping") && (
              <p className="text-base pl-5 mt-2">
                ...
                usually due to issues such as difficulty locating the
                recipient's address, the recipient's phone number being
                unreachable, or the selected item being out of stock.
              </p>
            )}
          </section>
        </div>
